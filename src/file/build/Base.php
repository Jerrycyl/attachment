<?php 
namespace cylcode\attachment\file\build;

use cylcode\aliyun\oss\Oss;
...
class Base
{
     ...
     * @DateTime 2019-06-18T19:41:53+0800
     * @Example  eg:
     * @return   [type]                   [description]
     */
    public function createFileName(){
        return mt_rand(1, 9999).time().date('YmdHis');
    }
    /**
     * 储存文件
     *
    ...
    private function save($file)
    {
        if ($this->mold == 'oss') {
            ...
            $sha1File = sha1_file($file['tmp_name']);
            $fileName = $this->createFileName().".".$file['ext'];
     ...
     * [getInfo 返出标准]
     * @Author   Jerry                    (wx621201)
     * @DateTime 2019-06-18T19:32:25+0800
     * @Example  eg:
